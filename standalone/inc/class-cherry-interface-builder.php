...
if ( ! class_exists( 'Cherry4_Interface_Builder' ) ) {
	class Cherry4_Interface_Builder {
		...
		public static function inc() {
			if ( ! class_exists( 'Cherry_Core' ) ) {
				require_once( dirname( __FILE__ ) . '/ui-elements/ui-text/ui-text.php' );
				require_once( dirname( __FILE__ ) . '/ui-elements/ui-textarea/ui-textarea.php' );
				require_once( dirname( __FILE__ ) . '/ui-elements/ui-switcher/ui-switcher.php' );

				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-select/ui-select.php' );
				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-checkbox/ui-checkbox.php' );
				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-radio/ui-radio.php' );
				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-colorpicker/ui-colorpicker.php' );
				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-repeater/ui-repeater.php' );
				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-media/ui-media.php' );
				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-stepper/ui-stepper.php' );
				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-slider/ui-slider.php' );
				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-range-slider/ui-range-slider.php' );
				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-background/ui-background.php' );
				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-typography/ui-typography.php' );
				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-ace-editor/ui-ace-editor.php' );
				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-layout-editor/ui-layout-editor.php' );
				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-static-area-editor/ui-static-area-editor.php' );
				// require_once( dirname( __FILE__ ) . '/ui-elements/ui-tooltip/ui-tooltip.php' );
			}
		}
		...
		*/
		...
		public static function enqueue_assets() {
			add_action( 'admin_enqueue_scripts', array( __CLASS__, 'enqueue_builder_scripts' ) );
			add_action( 'admin_enqueue_scripts', array( __CLASS__, 'enqueue_builder_styles' ) );
		}
		 ...
		 * @since 4.0.0
		 */
		public static function enqueue_builder_scripts( $hook_suffix = false ) {
			if ( ! class_exists( 'Cherry_Core' ) ) {
				...
				wp_enqueue_script( 'interface-builder', CHERRY_SERVICES_URI . 'standalone/assets/js/interface-builder.js', array( 'jquery' ), '1.0.0', true );
			}
		}
		 ...
		 * @since 4.0.0
		 */
		public static function enqueue_builder_styles( $hook_suffix = false ) {
			wp_enqueue_style( 'admin-interface', CHERRY_SERVICES_URI . 'standalone/assets/css/admin-interface.css', array(), '1.0.0' );

			if ( ! class_exists( 'Cherry_Core' ) ) {
				wp_enqueue_style( 'interface-builder', CHERRY_SERVICES_URI . 'standalone/assets/css/interface-builder.css', array(), '1.0.0' );
				wp_enqueue_style( 'cherry-ui-elements', CHERRY_SERVICES_URI . 'standalone/assets/css/cherry-ui-elements.css', array(), '1.0.0' );
			}
		}
	}
}
